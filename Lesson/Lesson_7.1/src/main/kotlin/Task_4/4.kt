 ...
 * @return возвращает строку разбитую на слова пробелами, после обработки объединяю слова пробелами,
 * если в слове больше 1 символа где первый и последний символ буквы, меняю местами первую и последнюю букву
 *
 * Или
 *  @param fun swapLetter2(str: String) :String {
